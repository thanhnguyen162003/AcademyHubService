using AcademyHubService.ReadModel.Projections;
...
using AcademyHubService.ReadModel.Projections.EventStoreDB;
using AcademyHubService.ReadModel.Impl;

namespace AcademyHubService.ReadModel.App;
