...
namespace Application.Controllers
{
    ...
    public class SubmissionController : Controller
    {
        ...
        [ProducesResponseType(typeof(GetSubmissionQuery), StatusCodes.Status200OK)]
        [Authorize()]
        public async Task<IActionResult> GetZoneDetail(Guid assignmentId, [FromQuery] GetSubmissionQuery getSubmissionQuery, CancellationToken cancellationToken = default)
        {
