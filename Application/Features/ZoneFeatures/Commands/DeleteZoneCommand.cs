...
namespace Application.Features.ZoneFeatures.Commands
{
    ...
    public class DeleteZoneCommandHandler : IRequestHandler<DeleteZoneCommand, APIResponse>
    {
        private readonly IUnitOfWork _unitOfWork;
        private readonly IAuthenticationService _authenticationService;

        public DeleteZoneCommandHandler(IUnitOfWork unitOfWork, IAuthenticationService authenticationService)
        {
