...
namespace Application.Features.MemberFeatures.Commands
{
    ...
    public class DeleteMemberCommandHandler : IRequestHandler<DeleteMemberCommand, APIResponse>
    {
        private readonly IUnitOfWork _unitOfWork;
        private readonly IAuthenticationService _authenticationService;

        public DeleteMemberCommandHandler(IUnitOfWork unitOfWork, IAuthenticationService authenticationService)
        {
        ...
        public async Task<APIResponse> Handle(DeleteMemberCommand request, CancellationToken cancellationToken)
        {
            ...
            {
                await _unitOfWork.ZoneMembershipRepository.Delete(zoneMembership);
            }
