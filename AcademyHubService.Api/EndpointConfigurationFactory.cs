internal class EndpointConfigurationFactory
{
    ...
    static void SetupRouting(TransportExtensions<RabbitMQTransport> transport, IConfiguration config)
    {
        ...
        routing.RouteToEndpoint(
            assembly: typeof(AcademyHubService.PL.Commands.RegisterOrganization).Assembly,
    ...
    static void SetupConventions(EndpointConfiguration endpointConfiguration)
    {
        ...
        conventions.DefiningCommandsAs(type => type.Namespace == "AcademyHubService.PL.Commands");
        conventions.DefiningEventsAs(type => type.Namespace == "AcademyHubService.PL.Events");
        conventions.DefiningMessagesAs(type => type.Namespace == "AcademyHubService.PL.Messages");
    }
}